...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView navuser = headerview.findViewById(R.id.tv_username);

        navuser.setText(""+successlogin);
        Toast.makeText(getApplicationContext(),"Welcome "+successlogin,Toast.LENGTH_LONG).show();
